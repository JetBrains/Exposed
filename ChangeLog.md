...
Also, `offset` parameter of `SizedIterable.limit()` function was changed accordingly. `limit` parameter stays untouched to be in sync with Kotlin `Collection.size`
