...
@InternalApi
fun areEquivalentColumnTypesInternal(columnMetadataSqlType: String, columnMetadataType: Int, columnType: String): Boolean {
    return when {
...
private fun areEquivalentColumnTypesH2(columnMetadataSqlType: String, columnMetadataJdbcType: Int, columnType: String): Boolean {
    ...
    if (columnMetadataJdbcType == Types.ARRAY) {
        ...
        return areEquivalentColumnTypesInternal(baseType, Types.OTHER, columnType.substringBefore(" ARRAY")) &&
            areEquivalentColumnTypesInternal(columnMetadataSqlType.replaceBefore("ARRAY", ""), Types.OTHER, columnType.replaceBefore("ARRAY", ""))
    }
        ...
        H2CompatibilityMode.SQLServer ->
            when {
                ...
                columnType.contains(" IDENTITY") ->
                    areEquivalentColumnTypesInternal(columnMetadataSqlType, columnMetadataJdbcType, columnType.substringBefore(" IDENTITY"))
        ...
        null, H2CompatibilityMode.MySQL, H2CompatibilityMode.MariaDB ->
            when {
                ...
                columnType.contains(" AUTO_INCREMENT") ->
                    areEquivalentColumnTypesInternal(columnMetadataSqlType, columnMetadataJdbcType, columnType.substringBefore(" AUTO_INCREMENT"))
