...
open class Transaction(
    ...
    /** All registered [StatementInterceptor]s on this transaction that implement the [SqlLogger] interface. */
    @InternalApi
    val loggingInterceptors: List<SqlLogger>
        get() = interceptors.filterIsInstance<SqlLogger>()
     ...
     * are stored for each call in [Transaction.statementStats].
     */
    // this should be split, but executeIn should most likely remain internal to Statement...
