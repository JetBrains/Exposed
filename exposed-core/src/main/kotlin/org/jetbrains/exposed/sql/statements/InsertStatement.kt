...
open class InsertStatement<Key : Any>(
    ...
    private fun processResults(rs: ResultSet?, inserted: Int): List<ResultRow> {
        ...
        val nullableColumnsValues = table.columns.filter {
            it.columnType.nullable && !it.hasDefault()
        }.associateWith { null }
        ...
        return arguments!!
            .mapIndexed { index, columnValues ->
                ...
                nullableColumnsValues + argumentValues + resultSetValues
            }
            .map { ResultRow.createAndFillValues(it as Map<Expression<*>, Any?>) }
    }

    private fun Column<*>.hasDefault() = this.dbDefaultValue != null || this.defaultValueFun != null || this.isDatabaseGenerated
    ...
    protected fun clientDefaultColumns() = targets.flatMap { it.columns.filter { column -> column.dbDefaultValue == null && column.defaultValueFun != null } }
