...
class R2dbcArrayColumnTypeTests : R2dbcDatabaseTestsBase() {
    ...
    class ArrayTestDao(id: EntityID<Int>) : IntR2dbcEntity(id) {
        companion object : IntR2dbcEntityClass<ArrayTestDao>(ArrayTestTable)
