...
class R2dbcVectorColumnTypeTests : R2dbcDatabaseTestsBase() {
    ...
    class VectorEntity(id: EntityID<Int>) : IntR2dbcEntity(id) {
        companion object : IntR2dbcEntityClass<VectorEntity>(VectorEntityTable)
