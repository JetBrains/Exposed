...
class CreateIndexTests : DatabaseTestsBase() {
    ...
    fun createAndDropHashIndex() {
        ...
        withTables(
            excludeSettings = TestDB.ALL_H2_V2 + TestDB.SQLSERVER + TestDB.ORACLE + TestDB.SQLITE,
    ...
    private fun JdbcTransaction.getIndicesFromMetadata(table: Table): List<Index> {
