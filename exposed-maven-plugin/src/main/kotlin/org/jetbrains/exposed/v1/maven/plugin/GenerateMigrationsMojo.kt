...
class GenerateMigrationsMojo : AbstractMojo() {
     ...
     */
    @field:Parameter(
        property = "exposed.migrations.fileDirectory",
     ...
     */
    @field:Parameter(property = "exposed.migrations.filePrefix", defaultValue = "V")
     ...
     */
    @field:Parameter(property = "exposed.migrations.fileVersionFormat", defaultValue = "TIMESTAMP_ONLY")
    var fileVersionFormat: VersionFormat = VersionFormat.TIMESTAMP_ONLY

    /**
     * Separator for migration script names. Defaults to `__`.
     */
    @field:Parameter(property = "exposed.migrations.fileSeparator", defaultValue = "__")
     ...
     * Defaults to `true`.
     */
    @field:Parameter(property = "exposed.migrations.useUpperCaseDescription", defaultValue = "true")
    var useUpperCaseDescription: Boolean = true

    /**
     * File extension for migration scripts. Defaults to `.sql`.
     */
    @field:Parameter(property = "exposed.migrations.fileExtension", defaultValue = ".sql")
     ...
     */
    @field:Parameter(property = "exposed.migrations.filename")
     ...
     */
    @field:Parameter(property = "exposed.migrations.databaseUrl")
     ...
     * Required when [testContainersImageName] is not set.
     */
    @field:Parameter(property = "exposed.migrations.databaseUser")
     ...
     * Required when [testContainersImageName] is not set.
     */
    @field:Parameter(property = "exposed.migrations.databasePassword")
     ...
     */
    @field:Parameter(property = "exposed.migrations.testContainersImageName")
    var testContainersImageName: String? = null

    /**
     * Whether to enable debug logging.
     */
    @field:Parameter(property = "exposed.migrations.debug", defaultValue = "false")
