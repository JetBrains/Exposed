...
open class Query(
    ...
    /**
     * Assigns a new column set, either a [org.jetbrains.exposed.sql.Table] or a [org.jetbrains.exposed.sql.Join], by changing the `source` property of this query's [set],
