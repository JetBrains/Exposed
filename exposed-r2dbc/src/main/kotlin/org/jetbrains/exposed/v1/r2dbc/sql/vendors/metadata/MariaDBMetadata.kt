...
internal object MariaDBTypeProvider : org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.MySQLTypeProvider() {
    ...
    override val bitType: org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.SqlTypeProvider.DataType
        get() = super.bitType.copy(precision = numericPrecision)

    // problematic: used for both byte and bool types but returns different ids...
    override val tinyIntType: org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.SqlTypeProvider.DataType
        get() = super.tinyIntType.copy(code = -7, precision = numericPrecision)
}

internal class MariaDBMetadata : org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.MySQLMetadata() {
    override val propertyProvider: org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.PropertyProvider =
        org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.MariaDBPropertyProvider

    override val typeProvider: org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.SqlTypeProvider =
        org.jetbrains.exposed.v1.r2dbc.sql.vendors.metadata.MariaDBTypeProvider
