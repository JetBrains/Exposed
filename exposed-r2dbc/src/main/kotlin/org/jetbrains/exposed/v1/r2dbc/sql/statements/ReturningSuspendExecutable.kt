...
import org.jetbrains.exposed.v1.sql.statements.ReturningStatement
...
open class ReturningSuspendExecutable(
...
) : SuspendExecutable<ResultApi, ReturningStatement>, Flow<_root_ide_package_.org.jetbrains.exposed.v1.sql.ResultRow> {
    ...
    override suspend fun collect(collector: FlowCollector<_root_ide_package_.org.jetbrains.exposed.v1.sql.ResultRow>) {
        ...
        try {
            rs.mapRows {
                _root_ide_package_.org.jetbrains.exposed.v1.sql.ResultRow.create(it, fieldIndex)
