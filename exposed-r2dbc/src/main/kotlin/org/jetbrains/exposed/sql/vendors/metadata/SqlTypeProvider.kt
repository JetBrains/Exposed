package org.jetbrains.exposed.sql.vendors.metadata
...
abstract class SqlTypeProvider {
    ...
    /**
     * Appends a switch clause to a [stringBuilder] for the value stored in [columnName]. Each branch uses available
     * SQL types mapped to their [DataType.precision], in order to query the column size associated with the type.
     */
