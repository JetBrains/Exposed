...
- [exposed-jdbc-dao-sample](exposed-jdbc-dao-sample): Backend application built with the JDBC DAO API (`exposed-dao`).
- [exposed-r2dbc-dao-sample](exposed-r2dbc-dao-sample): The same application built with the R2DBC DAO API (`exposed-dao-r2dbc`).
