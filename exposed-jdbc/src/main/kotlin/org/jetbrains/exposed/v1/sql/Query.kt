...
open class Query(
    ...
    protected val transaction: org.jetbrains.exposed.v1.sql.JdbcTransaction
    ...
    override fun JdbcPreparedStatementApi.executeInternal(transaction: org.jetbrains.exposed.v1.sql.JdbcTransaction): JdbcResult? {
    ...
    companion object {
        private fun trackResultSet(transaction: org.jetbrains.exposed.v1.sql.JdbcTransaction) {
