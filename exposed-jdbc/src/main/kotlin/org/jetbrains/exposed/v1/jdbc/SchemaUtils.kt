...
object SchemaUtils : SchemaUtilityApi() {
    ...
    private fun JdbcTransaction.execStatements(inBatch: Boolean, statements: List<String>) {
        if (inBatch) {
     ...
     */
    fun listTables(): List<String> = currentDialectMetadata.allTablesNames()
     ...
     * @return A list of table names as strings.
     */
    fun listTablesInAllSchemas(): List<String> = currentDialectMetadata.allTablesNamesInAllSchemas()
