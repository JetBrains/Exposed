...
sealed class SetOperation(
    ...
    init {
        ...
        require(rawStatements.none { it is org.jetbrains.exposed.v1.sql.Query && it.isForUpdate() }) { "FOR UPDATE is not allowed within $operationName" }
 ...
 */
fun AbstractQuery<*>.union(other: org.jetbrains.exposed.v1.sql.Query): Union = Union(this, other)
 ...
 */
fun AbstractQuery<*>.unionAll(other: org.jetbrains.exposed.v1.sql.Query): UnionAll = UnionAll(this, other)
 ...
 */
fun AbstractQuery<*>.intersect(other: org.jetbrains.exposed.v1.sql.Query): Intersect = Intersect(this, other)
 ...
 */
fun AbstractQuery<*>.except(other: org.jetbrains.exposed.v1.sql.Query): Except = Except(this, other)
