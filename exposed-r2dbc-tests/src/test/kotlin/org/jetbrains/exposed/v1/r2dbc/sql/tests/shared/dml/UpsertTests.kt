...
import org.jetbrains.exposed.v1.r2dbc.sql.batchUpsert
...
import org.jetbrains.exposed.v1.r2dbc.sql.upsert
...
import org.jetbrains.exposed.v1.sql.statements.UpsertBuilder
import org.jetbrains.exposed.v1.sql.stringLiteral
import org.jetbrains.exposed.v1.sql.stringParam
...
class UpsertTests : R2dbcDatabaseTestsBase() {
    ...
    fun testUpsertWithAllColumnsInPK() {
        ...
        suspend fun upsertOnlyKeyColumns(values: Pair<String, String>) {
            tester.upsert {
    ...
    fun testUpsertWithNoUniqueConstraints() {
        ...
        val okWithNoUniquenessDB = TestDB.ALL_MYSQL_LIKE
