...
class InsertTests : R2dbcDatabaseTestsBase() {
    ...
    @Test
    fun testInsertAndGetId01() = runTest {
    ...
    @Test
    fun testInsertIgnoreAndGetId01() = runTest {
        val idTable = object : IntIdTable("tmp") {
            val name = varchar("foo", 10).uniqueIndex()
        }
    ...
    @Test
    fun testInsertIgnoreAndGetIdWithPredefinedId() = runTest {
        val idTable = object : IntIdTable("tmp") {
            val name = varchar("foo", 10).uniqueIndex()
        }
    ...
    @Test
    fun testBatchInsertWithSequence() = runTest {
    ...
    @Test
    fun `batchInserting using empty sequence should work`() = runTest {
        val cities = DMLTestsData.Cities
        withTables(cities) {
    ...
    @Test
    fun testGeneratedKey01() = runTest {
    ...
    @Test
    fun testGeneratedKey02() = runTest {
    ...
    @Test
    fun testGeneratedKey03() = runTest {
    ...
    @Test
    fun testInsertWithForeignId() = runTest {
    ...
    @Test
    fun testInsertWithColumnExpression() = runTest {
    ...
    @Test
    fun testInsertEmojisWithInvalidLength() = runTest {
        val table = object : Table("tmp") {
    ...
    @Test
    fun `test that column length checked on insert`() = runTest {
    ...
    @Test
    fun `test subquery in an insert or update statement`() = runTest {
    ...
    @Test
    fun testGeneratedKey04() = runTest {
    ...
    @Test
    fun testRollbackOnConstraintExceptionWithNormalTransactions() = runTest {
    ...
    @Test
    fun testBatchInsertNumberOfInsertedRows() = runTest {
    ...
    @Test
    fun testInsertIntoNullableGeneratedColumn() = runTest {
        withDb { testDb ->
    ...
    @Test
    fun testNoAutoIncrementAppliedToCustomStringPrimaryKey() = runTest {
    ...
    @Test
    fun testInsertReturnsValuesFromDefaultExpression() = runTest {
    ...
    @Test
    fun testDatabaseGeneratedUUIDasPrimaryKey() = runTest {
    ...
    @Test
    fun testDefaultValuesAndNullableColumnsNotInBatchInsertArguments() = runTest {
    ...
    @Test
    fun testInsertOfDefaultValuesOnly() = runTest {
